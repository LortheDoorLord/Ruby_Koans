...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # My explanation: 
    # ---------------------------------
    # Inject takes a number and a function. The function defines both
    # how the injection interacts with the items in an array and how the
    # items in an array interact with each other. Injecting a number into
    # the array will apply the number via the function to each item in the 
    # array before these items are combined via the function.
